...
class Parser:
    ...
    def extract_log_lines_by_timestamps(self,
                                        start_time: str,
                                        end_time: str,
    ...
    def extract_detailed_process_log(self,
    ...
    def _extract_nested_subprocess_logs(self,
    ...
    def save_process_log_to_file(self,
                                 process_data: Dict[str, Any],
    ...
    def _save_subprocess_logs_to_file(self,
